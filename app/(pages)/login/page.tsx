...
const LoginPage = () => {
  ...
  return (
    <main className="min-h-screen bg-zinc-900 flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-gray-900 text-white rounded-xl shadow-2xl p-8 space-y-6 border border-gray-700">
        <div className="text-center space-y-2">
          <h2 className="text-2xl font-bold">Welcome to Kidztory</h2>
        ...
        <div className="flex flex-col gap-4">
          <Button
            ...
            variant="outline"
            className="w-full gap-2 border rounded-md text-sm bg-white text-white hover:bg-gray-100"
          >
            <GoogleIcon />
            Login with Google
          </Button>
